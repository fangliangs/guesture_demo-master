...
public class PlayerActivity extends BaseActivity implements IVLCVout.OnNewVideoLayoutListener {
    public static final String MEDIA_FILE_NAME = "dzq.avi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            try {
                final Media media = new Media(mLibVLC,MEDIA_PATH);
                mMediaPlayer.setMedia(media);
                media.release();
            } catch (Exception e) {
                ToastX.show(e.toString());
                Log.i("PlayerActivity",e.toString());
            ...
            Log.i("PlayerActivity","PlayerActivity oncreate error : "+ e.toString());
