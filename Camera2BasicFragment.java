...
import com.example.gesturerecognition.Classifier;
...
public class Camera2BasicFragment extends Fragment
  ...
  public void onViewCreated(final View view, Bundle savedInstanceState) {
    ...
    imageview_instance = (ImageView) view.findViewById(R.id.imageView);
  }
...
//    }
    PermissionsUtil.requestPermission(getActivity(), new PermissionListener() {
      ...
      public void permissionGranted(@NonNull String[] permissions) {
        checkedPermissions = true;
        Toast.makeText(getActivity(), "访问摄像头", Toast.LENGTH_LONG).show();
      }

      @Override
      public void permissionDenied(@NonNull String[] permissions) {
        checkedPermissions = false;
        Toast.makeText(getActivity(), "用户拒绝了访问摄像头", Toast.LENGTH_LONG).show();
      }
...
//                    e.printStackTrace();
//                }
        Toast.makeText(getActivity(), "您成功授权摄像头权限", Toast.LENGTH_LONG).show();
      }

      @Override
      public void permissionDenied(@NonNull String[] permissions) {
        Toast.makeText(getActivity(), "您拒绝了摄像头权限", Toast.LENGTH_LONG).show();
      }
